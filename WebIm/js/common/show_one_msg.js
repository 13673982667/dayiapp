...
function addMsg(msg,prepend) {
    ...
    res.isSend = msg.getIsSend();//消息是否为自己发的
    
//	pushMsg
    res.fromAccountNick = fromAccount = msg.getFromAccount();//发送方
    ...
    if(isSelfSend){//如果是自己发的消息
        ...
        res.fromAccountNick = fromAccountNick; //昵称
        res.fromAccountImage = fromAccountImage //头像
...
//          console.log(msg);
	...
	res.content = convertMsgtoHtml(msg);
